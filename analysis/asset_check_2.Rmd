...
cnic_flags%>%
  ...
  write_csv("data/cnic_length_num_errors.csv", append=F)

table(cnic_flags$cnic_in_scrutiny)

cnic_flags%>%
  filter(!cnic_in_scrutiny)%>%
  write_csv("data/cnics_not_in_scrutiny.csv", append=F)
...
str(dup_by_uid$uid)
  ...
  write_csv(dup_by_uid,"data/duplicated_uids.csv", append = F)
```
