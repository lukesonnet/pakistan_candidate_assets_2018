...
final_assets <- read_dta("C:/Users/Ibrahim Amir/Dropbox/Pakistan_Assets/data/Luke_08282018_Asset.dta")%>%
...
scrutiny_list <- read_csv("C:/Users/Ibrahim Amir/Dropbox/Pakistan_Assets/data/candidate_scrutiny_list.csv")%>%
  mutate(cnic=as.character(candidate_CNIC_ECP))
final_cand_uids <- read_excel("C:/Users/Ibrahim Amir/Dropbox/Pakistan_Assets/data/candidate_uids_complete.xls")
...
write.csv(errs, file = "C:/Users/Ibrahim Amir/Dropbox/Pakistan_Assets/data/flagged_entries_final.csv", row.names = FALSE)
...
# 
# write.csv(missing_cnics_raw, file = "C:/Users/Ibrahim Amir/Dropbox/Pakistan_Assets/data/missing_cnics.csv", row.names = FALSE)
