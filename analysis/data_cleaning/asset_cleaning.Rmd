...
```
##### CNICs:
Still waiting on correct CNICs to come from AT before proceeding
...
Still to clean:
1. CNICs: add in corrected CNICs sent by AT and make new correct CNIC var similar to UID case correction
2. Categorize **educ**, **occup**.
3. Waiting on AT for **motor_cost** and **motor_number** which currently have no observations.
4. Value for agri land holding?
